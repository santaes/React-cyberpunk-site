    ...
    <>
      <div className='absolute w-full h-24 bg-black text-white z-20'>
        <div className='flex justify-between items-center max-w-screen-xl mx-auto px-4 h-full'>
          <div>
            <h1 className='text-thBlue tracking-widest text-3xl'>BATSOL</h1>
          </div>
          <div className='hidden lg:flex items-center'>
            ...
            <GradientBtn title={'Get Batsol'} className='ml-4 capitalize ' />
          </div>
          <div
      ...
      <div
        className={`w-full bg-black text-white absolute z-10 left-0 h-fit py-12 lg:hidden flex justify-center text-2xl capitalize duration-500 ${
      ...
      >
        <ul className='text-center'>
          ...
          <GradientBtn className='mt-10 capitalize' title={'get batsol'} />
        </ul>
      </div>
    </>
  );
